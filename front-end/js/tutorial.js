  ...
  function init() {
    ...
    tutorial_tool = new edaplotjs.TutorialTool("#tutorial-tool-container", {
      ...
      on_tutorial_finished: function (num_tries_to_pass) {
        ...
        // Based on the attempts, give the tutorial finisher (and Pro, if applicable)
        util.postJSON(api_url_root + "tutorial_achievement", {
          "user_id": currentUserId,
          "action_type": 5 - num_tries_to_pass,
        }, {
          error: function (xhr) {
            console.error("Error when adding tutorial achievement");
          }
        });
